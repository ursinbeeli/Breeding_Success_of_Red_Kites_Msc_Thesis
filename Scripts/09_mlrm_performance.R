...
if (!dir.exists(here("../Data/Output/09_mlrm_performance"))) {
  if (!dir.exists(here("../Data/Output"))) {
    dir.create("../Data/Output")
  }
  dir.create("../Data/Output/09_mlrm_performance")
}
...
# Saving data frame
write.csv(a_raw_output_analysis, here("../Data/Output/09_mlrm_performance/03_brood_phase_prediction_raw.csv"),
          row.names = F)
...
# Saving data frame
write.csv(b_merged_categories_grouped, here("../Data/Output/09_mlrm_performance/04_brood_phase_prediction_merged_categories.csv"),
          row.names = F)
...
# Saving data frame
write.csv(c_rule_based_adaptation_grouped, here("../Data/Output/09_mlrm_performance/05_brood_phase_prediction_rule_based_adaptation.csv"),
          row.names = F)
